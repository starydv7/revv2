...
avatar.src="https://images.pexels.com/photos/112460/pexels-photo-112460.jpeg?auto=compress&cs=tinysrgb&w=400";
...
h4.innerText="Kms Driven:-"+elem.kilo
...
console.log(name,"d")
console.log("cdi")
fetch(`https://masai-apicars.herokuapp.com/cars?q=${name}`)
.then(function (response) {
return response.json();
})
.then(function (products) {
